...
function Header(props) {
  ...
  const [{ location, search }, setLocationAndSearch] = useContext(
    LocationAndSearchContext
  );
              ...
              >
                <ul className="navbar-nav" style={{ marginLeft: "5%" }}>
                  ...
                  >
                    ...
                    >
                      <li>
                        <div className="dropdown-item" onClick={updateLocation}>
                          Pakistan
                        </div>
                      </li>
                      <li>
                          ...
                          <div className="loginProfileDiv">
                            <figure
                              style={{
                                width: "56px",
                                height: "56px",
                                backgroundImage: login.isLoggedIn
                                  ? `url(https://img.icons8.com/fluent-systems-filled/40/1ABC9C/circled-${login.name[0].toLowerCase()}.png)`
                                  : "",
                                flex: "0 0 56px",
                  ...
                  <li className="nav-item" style={{ marginRight: "" }}>
                    <div className="" style={{ position: "relative" }}>
                      ...
                      <Link
                        to={
                          login && login.isLoggedIn ? "/postyourad" : "/login"
                        }
                      >
                        <button
                          type="button"
...
//           <form onSubmit={submitSearch} className="d-flex">
//             <input onChange={updateText} style={{width:'325px'}} type="text" value={inputSearch} className="form-control me-2" placeholder="Find Cars, Mobile Phones and more..." aria-label="Search"/>
...
//                   <div style={{ padding: '2px 16px 0 0' }}>
//                     <svg width="23px" height="23px" viewBox="0 0 1024 1024" data-aut-id="icon" className="" fillRule="evenodd"><path className="rui-77aaa" d="M128 85.333l-42.667 42.667v768l42.667 42.667h768l42.667-42.667v-213.333l-42.667-42.667-42.667 42.667v170.667h-682.667v-682.667h682.667v170.667l42.667 42.667 42.667-42.667v-213.333l-42.667-42.667h-768zM494.336 298.667l-183.168 183.168v60.331l183.168 183.168h60.331v-60.331l-110.336-110.336h323.669l42.667-42.667-42.667-42.667h-323.669l110.336-110.336v-60.331h-60.331z"></path></svg>

...
function CatagoryView() {
  ...
  if (!isLoading && currentCategory !== category) {
    ...
    if (categoryList.includes(category.toLowerCase())) {
      ...
      setList(
        itemList.filter((item) => item.category === category.toLowerCase())
      );
    } else {
      setLocationAndSearch({
        location,
  ...
  function drop() {
    if (
      loc === "collapsedContent toVisible" &&
      sloc === "unCollaspedContent isVisible"
    ) {
  ...
  useEffect(() => {
    if (priceFilter && location !== "Pakistan") {
      ...
      setFilteredList(list.filter((item) => item.state === location));
    } else {
                    ...
                    <div className="LocationDiv">
                      ...
                      <div className={sloc}>
                        <ul className="unCollaspedContentUl">
                          <li>
                            <span className="unCollaspedContentHeading">
                              {location}
                            </span>
                            <ul className="unCollaspedDropdownDiv">
                              <li onClick={locationValue}>
                                <span className="unCollaspedDropdownItem">
                                  Pakistan
                                </span>
                              </li>
                              <li onClick={locationValue}>
              ...
              {!isLoading ? (
                <div className="ItemsDiv">
                  <ul className="ul1 ul2 row">
                    {(filteredList ? filteredList : list).length === 0 ? (
                  ...
                  {(filteredList ? filteredList : list).length >
                    countOfItems && (
